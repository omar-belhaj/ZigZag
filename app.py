...
def main():
    ...
    max_tokens = st.sidebar.slider("Nombre maximum de tokens pour la réponse", 50, 2000, 150)
    ...
    if user_input:
        ...
        with st.spinner("Je réfléchis à ta question..."):
            result = query_with_external_knowledge(user_input, top_k=top_k, temperature=temperature, max_tokens=max_tokens, age_specific_prompt=age_specific_prompt)
